...
def hdr_hplc(amt, fn_docs):
    ...
    _fields ='sample,station,depth,lat,lon,year,month,day,time,volfilt,allo,alpha-beta-car,but-fuco,chl_c1c2,chl_c3,chlide_a,diadino,diato,dp,dv_chl_a,dv_chl_b,fuco,hex-fuco,lut,neo,perid,phide_a,phytin_a,ppc,pras,psc,psp,tacc,tcar,tchl,tot_chl_a,tot_chl_b,tot_chl_c,tpg,viola,zea' # caution: copied from hdr function
    _units = 'none,none,m,degrees,degrees,yyyy,mo,dd,HH:MM:SS,l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l,ug/l'
...
def data_table(amt):
    ...
    acs_chl_debiased = amt['acx_chl_debiased_nomedfilt'].to_pandas() # Include non-medfilt data as standard
...
def data_table_hplc(amt):
    ...
    sample = amt['hplc_Horn_Point_Lab_sample_code'].to_pandas() 
 ...
 #   bottle = amt['hplc_Bottle_Number'].to_pandas() # check 
    ...
    # gyro = amt['hplc_Gyro'].to_pandas() - not in 19 but in 22
    hex_fuco = amt['hplc_Hex-fuco'].to_pandas()
    lut = amt['hplc_Lut'].to_pandas()
    # mv_chl_a = amt['hplc_MV_Chl_a'].to_pandas() - not in 19 but in 22
    # mv_chl_b = amt['hplc_MV_Chl_b'].to_pandas() -not in 19 but in 22
    ...
    print('     concatenating Series...')    
    amt2csv = pd.concat([sample,station,depth,lat,lon,year,month,day,time,volfilt,allo,alpha_beta_car,but_fuco,chl_c1c2,chl_c3,chlide_a,diadino,diato,dp,dv_chl_a,dv_chl_b,fuco,hex_fuco,lut,neo,perid,phide_a,phytin_a,ppc,pras,psc,psp,tacc,tcar,tchl,tot_chl_a,tot_chl_b,tot_chl_c,tpg,viola,zea],  axis=1)
...
if __name__ == '__main__':
        ...
        # nc file
        finalnc = '/users/rsg/tjor/scratch_network/AMT_underway/AMT19/Processed/Step3/amt19_final_with_debiased_chl.nc' # hardcoded
        amt_no = finalnc.split("/")[-1].split("_")[0]

        # calibration file
 
        fn_cal_acs = 'acs007.dev' 
        fn_cal_ac9 = 'ac90274.dev' 
        
        # document files
        fn_docs_acs = 'checklist_acs_particulate_inline_AMT19.rtf,checklist_acs_ag_cg_AMT19.rtf,AMT19_ACS_AC9_inline_ProcessingReport.docx' # hardcoded
        fn_docs_ac9 = 'checklist_ac9_particulate_inline_AMT19.rtf,checklist_ac9_ag_cg_AMT19.rtf,AMT19_ACS_AC9_inline_ProcessingReport.docx'
        fn_docs_hplc = 'checklist_hplc_NASA_AMT19.rtf,hplc_amt19.xlsx,HPLC_method_summary.pdf'
        ...
        export_2_seabass(header_acs, amt2csv, fnout_acs)
        # write file
